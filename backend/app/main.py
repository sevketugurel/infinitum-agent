...
from .services.serpapi_service import get_serpapi_account_info
from .db.firestore_client import db  # This will initialize Firebase
from .services.vertex_ai import llm, ask_gemini, get_quota_status, get_cache_stats, clear_cache
...
from .core.logging_dashboard import create_dashboard_routes, setup_log_capture, get_logging_health
...
async def llm_status():
    ...
    try:
        from .services.vertex_ai import llm

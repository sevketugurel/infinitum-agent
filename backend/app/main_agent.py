...
from .services.serpapi_service import search_google, search_google_shopping
from .services.user_context_service import user_context_manager
from .services.semantic_search_service import semantic_search_service
from .services.package_templates import package_template_service
from .db.firestore_client import db, save_product_snapshot
import uuid

# Import structured logging
from .core.logging_config import get_agent_logger, log_agent_step, PerformanceTimer

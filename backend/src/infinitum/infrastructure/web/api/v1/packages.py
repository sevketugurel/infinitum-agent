...
from .....application.use_cases.main_agent import process_user_query
from ....external.search.serpapi_client import test_serpapi_connection
...
async def packages_health_check():
    ...
    try:
        ...
        try:
            from ....external.scraping.crawl4ai_client import get_structured_data

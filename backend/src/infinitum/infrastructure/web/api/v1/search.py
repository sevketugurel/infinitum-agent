...
from .....application.use_cases.product_crew import product_crew
from ....persistence.firestore_client import save_product_snapshot
from ....external.scraping.crawl4ai_client import get_structured_data_sync
import time
import json

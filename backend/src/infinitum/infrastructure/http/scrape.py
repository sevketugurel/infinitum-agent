# File: src/infinitum/infrastructure/http/scrape.py
from fastapi import APIRouter, HTTPException
from pydantic import BaseModel
from infinitum.application.use_cases.product_crew import product_crew
from infinitum.infrastructure.persistence.firestore_client import save_product_snapshot
from infinitum.infrastructure.external_services.crawl4ai_service import get_structured_data_sync
import time
import json
